let phrases = [
    { 'text_0': 'Frontend Developer', 'text_1': 'ЦЦК ЭМИТ (1 год) и по итогу: создан текущий персональный сайт', 'text_2': 'РАНХиГС при Президенте РФ (2021-2025)', 'text_3': 'Python, C#, HTML, CSS, JavaScript, Git, ООП, Figma, Adobe Photoshop, Adobe Illustrator', image: 'https://sun9-65.userapi.com/impf/RPdkTsyAv3Cr6t2gAFNPYWBCw5bA5ETv47NS3w/LGkcS5hhcDw.jpg?size=960x1280&quality=95&sign=8ecd1a4f584f2c563c23f4c72ecb73a2&type=album' },
    ...
    { 'text_0': 'ГРГ Дня Знаний', 'text_1': 'Подготовка к мероприятию (2 месяца) и по итогу: посмотрим, что получится', 'text_2': 'Даже на школе ГРГ не готовят к этому', 'text_3': 'Организованность и генерация кринжовых идей; умение строить стротегии', image: 'https://sun9-50.userapi.com/impf/yfIPvXNPPsOeD5Et6xYCP1hXmlHWkgnf-ecdkQ/mYxXwFGUck8.jpg?size=960x1200&quality=95&sign=a31ce7fe2a23fd3e91abb5a0c216a619&type=album' },
    { 'text_0': 'Член ЦЦК ЭМИТ', 'text_1': 'Техник на мероприятиях и разработчик текущего сайта', 'text_2': 'ПИ ЭМИТ (2021-2025)', 'text_3': 'Научилась дизайнить пока отбиралась в ЦЦК разработчиком; \n научилась быть техником за пару минут до мероприятия', image: 'https://sun9-84.userapi.com/impf/ULBJ6AjpFNknVAINNoi4hl0yRY5WfTtiVZnRVA/ckOFehME2S8.jpg?size=960x1280&quality=95&sign=243385214615367ac7c63f70f090d2fc&type=album' },
